		...
		<?php 
			...
			if(breakpoint <= 600)
			{
			   ...
			   voff=slides.clientHeight - window.innerHeight;
					...
					var scene = new ScrollMagic.Scene({triggerElement: "body", duration: 100,offset:100})
					.addTo(vcontroller)
			...
			sections.forEach((elem, i) => {
			  ...
			  const tl = gsap.timeline( { 
			   ...
			   tl
				 .to(headlines, { opacity: 1, duration: 1, stagger: 0.1 })
				 .to(headlines, { opacity: .7, duration: 1, stagger: 0.1 }, 1 )
			   ;
		...
		function getClientId() {
			try {
				var e,
					t,
					n = ga.getAll();
				for (e = 0, t = n.length; e < t; e += 1) if ("UA-88663511-2" === n[e].get("trackingId")) return console.log("m"), n[e].get("clientId");
